...
async def test_create_event(mock_events_service):
    event_data = {'location':'Paris','date':'2028-10-10','description':'asasaasa','tag':'CONCERT','organizer_id':'123e4567-e89b-12d3-a456-426614174000'}
    expected_result = '555b998c-f268-4ed4-a925-b4d6b84a7efd'
...
async def test_update_event_by_id(mock_events_service):
    ...
    expected_result = Event(id='555b998c-f268-4ed4-a925-b4d6b84a7efd',location='Paris',date='2028-10-10',description='new description',created_at='2024-06-19 14:23:45',tag_id='CONCERT',organizer_id = '123e4567-e89b-12d3-a456-426614174000')

    event_id = '555b998c-f268-4ed4-a925-b4d6b84a7efd'
    ...
    assert result == expected_result
    mock_events_service.events_repository.update_one.assert_called_once_with(new_data,event_id)


@pytest.mark.asyncio
async def test_delete_event(mock_events_service):
    event_id  = '555b998c-f268-4ed4-a925-b4d6b84a7efd'
    expected_result = Event(id='555b998c-f268-4ed4-a925-b4d6b84a7efd', location='Paris', date='2028-10-10',
                            description='new description', created_at='2024-06-19 14:23:45', tag_id='CONCERT',
...
async def test_get_events(mock_events_service):
    ...
    assert result != expected_result
    mock_events_service.events_repository.get_many.assert_not_called()
...
async def test_get_filtered_events(mock_events_service):
  ...
  "pagination": {
    ...
    expected_result = []
    mock_events_service.events_repository.get_all_by_filters.return_value = expected_result
    result = await mock_events_service.get_filtered_events(data)
    assert result == expected_result
    assert isinstance(result,list)
    mock_events_service.events_repository.get_all_by_filters.assert_called_once()